...
admin_email = get_from_env('ADMIN_EMAIL','' )
if admin_email:
...
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Sistema de Votação da UFLA')
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'Sistema de Votação Eletrônica')
MAIN_LOGO_URL = get_from_env('MAIN_LOGO_URL', '/static/logo-ufla.png')
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "Bem Vindo ao Sistema de Votação Eletrônica da UFLA")
...
AUTH_ENABLED_SYSTEMS = get_from_env('AUTH_ENABLED_SYSTEMS', get_from_env('AUTH_ENABLED_AUTH_SYSTEMS', 'ldap')).split(",")
...
CELERY_BROKER_URL = get_from_env('CELERY_BROKER_URL', 'amqp://guest:guest@localhost:5672')
...
# ldap
# see configuration example at https://pythonhosted.org/django-auth-ldap/example.html
AUTH_LDAP_SERVER_URI = "*************************" # replace by your Ldap URI
AUTH_LDAP_BIND_DN = "*****************"
